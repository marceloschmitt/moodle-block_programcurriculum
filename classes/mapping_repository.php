...
class mapping_repository {
    ...
    public function get_by_curriculum_with_details(int $curriculumid): array {
        ...
        $sql = "SELECT m.id AS mappingid, c.id AS externalcourseid, c.name AS externalcoursename, c.term, c.sortorder, m.moodlecourseid, co.fullname AS moodlecoursename
                  FROM {block_programcurriculum_mapping} m
