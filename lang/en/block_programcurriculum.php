...
$string['adddiscipline'] = 'Add discipline';
...
$string['deletedisciplinebody'] = 'This will delete "{$a}".';
$string['deletedisciplinetitle'] = 'Delete discipline?';
...
$string['movemodaltitlewithname'] = 'Move discipline: {$a}';
...
$string['listofdisciplines'] = 'List of disciplines';
